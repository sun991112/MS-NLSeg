...
from model.Trid.mixstyle import *
...
class ResNet(nn.Module):
    ...
    def forward(self, x,phase):
        ...
        x = self.bn1(x)
        x = self.relu(x)
        if 'layer0' in self.mixstyle_layers and phase == 'train':
            x = self.random(x)
        else:
            pass
        sfs.append(x)
        ...
        x = self.layer1(x)
        if 'layer1' in self.mixstyle_layers and phase == 'train':
            x = self.random(x)
        else:
            pass
        sfs.append(x)
        ...
        x = self.layer2(x)
        if 'layer2' in self.mixstyle_layers and phase == 'train':
            x = self.random(x)
        else:
            pass
        sfs.append(x)
        ...
        x = self.layer3(x)
        if 'layer3' in self.mixstyle_layers and phase == 'train':
            x = self.random(x)
        else:
            pass
        sfs.append(x)
        ...
        x = self.layer4(x)
        if 'layer4' in self.mixstyle_layers and phase == 'train':
            x = self.random(x)
        else:
            pass
